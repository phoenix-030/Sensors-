...
export default function Accelero() {
  ...
  const fast = () => Accelerometer.setUpdateInterval(16);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        <Text style={styles.text}>X : {x.toFixed(3)} g</Text>
        <Text style={styles.text}>Y : {y.toFixed(3)} g</Text>
        <Text style={styles.text}>Z : {z.toFixed(3)} g</Text>
      </View>
